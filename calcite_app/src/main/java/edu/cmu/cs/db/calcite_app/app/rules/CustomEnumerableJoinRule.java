...
import edu.cmu.cs.db.calcite_app.app.op.CustomNestedLoopJoin;
...
public class CustomEnumerableJoinRule extends ConverterRule {
  /** Default configuration. */
  public static final Config DEFAULT_CONFIG = Config.INSTANCE
      .withConversion(LogicalJoin.class, Convention.NONE,
          EnumerableConvention.INSTANCE, "CustomEnumerableJoinRule")
      .withRuleFactory(CustomEnumerableJoinRule::new);

  /** Called from the Config. */
  protected CustomEnumerableJoinRule(Config config) {
    super(config);
  }
  ...
  @Override public RelNode convert(RelNode rel) {
    ...
    return CustomNestedLoopJoin.create(
        left,
        right,
        join.getCondition(),
        join.getVariablesSet(),
